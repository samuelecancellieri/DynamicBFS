...
void mark_duplicate_edges_kernel(
    ...
    // xlib::binarySearchLBAllPos<BLOCK_SIZE>(graph_offsets, graph_offsets_count, smem, lambda);
}
...
void markOverwriteSrcDstKernel(
    ...
    // xlib::binarySearchLBAllPos<BLOCK_SIZE>(batch_src_offsets, batch_src_offsets_count, smem, lambda);
}
...
void appendBatchEdgesKernel(
    ...
    // xlib::binarySearchLBAllPos<BLOCK_SIZE>(batch_offsets, batch_offsets_count, smem, lambda);
}
